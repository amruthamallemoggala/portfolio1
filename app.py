...
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Room Occupancy Detection System',
        'description': 'Designed and implemented a real-time room occupancy detection system using sensor integration to identify presence of people',
        'image': 'project1.jpg',
        'technologies': ['Python', 'Sensors', 'Data Processing', 'Classification']
    },
    {
        'id': 2,
        'title': 'Desktop Notifier Application',
        'description': 'Developed a desktop application that displays real-time pop-up notifications for reminders and alerts with secure event handling',
        'image': 'project2.jpg',
        'technologies': ['Python', 'Desktop Application', 'Event Handling', 'Security']
    },
    {
        'id': 3,
        'title': 'More Projects',
        'description': 'Exploring different technologies and building innovative solutions',
        'image': 'project3.jpg',
        'technologies': ['Python', 'Java', 'HTML', 'CSS', 'SQL']
    }
]
...
SKILLS = {
    ...
    'Databases': ['SQL'],
    'Core Skills': ['Problem Solving', 'Communication', 'Collaboration', 'Time Management', 'Adaptability']
}
